    ...
    <div className="form-container">
      ...
      {showForm && (
        <div className="modal">
          ...
          <div className="terms-and-agree">
            <input type="checkbox" id="agree" />
            <label htmlFor="agree">
              I agree to the terms of service & privacy policy and also agree to receive my sketch via the email address I provided and consent to receive other relevant content from Soulmate Sketch via our newsletter which I can opt-out at any time.
            </label>
          </div>
